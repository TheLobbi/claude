# Lobbi Workflow Engine — Plugin Guide

## Purpose
Design and implement multi-step approval workflows, routing rules, escalation policies, and SLA tracking for insurance, mortgage, and financial services. 6 skills, 3 agents.

...
| Deep analysis of a hard problem | [`commands/cc-intel.md`](commands/cc-intel.md) + [`skills/cc-deep-code-intelligence/SKILL.md`](skills/cc-deep-code-intelligence/SKILL.md) |
...
| Enable autonomous mode | [`commands/cc-autonomy.md`](commands/cc-autonomy.md) + [`skills/cc-autonomy-mode/SKILL.md`](skills/cc-autonomy-mode/SKILL.md) |
...
5. **Cost awareness** — Opus for reasoning gates, Sonnet for implementation, Haiku for retrieval. See [`skills/cc-model-routing/SKILL.md`](skills/cc-model-routing/SKILL.md).

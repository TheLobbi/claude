...
## Overview
Claude Code Plugin Marketplace — curated collection of 44 Claude Code plugins
(38 in `plugins/`, 6 sub-plugins in `.claude/plugins/`) with marketplace-wide
...
- Installed plugins: `plugins/` (38 plugins)
